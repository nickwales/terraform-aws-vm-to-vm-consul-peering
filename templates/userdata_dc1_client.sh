...
### Personalize the web service for dc1
...
do 
  ...
  sleep 5
  server_addr=$(aws --region us-east-1 ec2 describe-instances --filters "Name=tag:Name,Values=server-dc1" \
...
retry_join = ["provider=aws tag_key=Name tag_value=server-dc1"]
EOT
